...
def linear_activation_forward(A_prev, W, b, activation):
    ...
    if activation == "sigmoid":
        ...
        ### START CODE HERE ### (≈ 2 lines of code)
#        print("sigmoid W.shape = {}".format(W.shape))
...
#    print("len parameters = {}".format(len(parameters)))
    ...
    for l in range(1, L):
        ...
        A, cache = linear_activation_forward(A_prev,
                                             ...
                                             "relu")
        caches.append(cache)
#        print("i = {} W.shape = {} A.shape = {}".format(l, parameters["W"+str(l)].shape, A_prev.shape))
        
        ### END CODE HERE ###
    # Implement LINEAR -> SIGMOID. Add "cache" to the "caches" list.
    ### START CODE HERE ### (≈ 2 lines of code)
#    print("W" + str(L))
#    print("i = {} W.shape = {} A.shape = {}".format(L, parameters["W"+str(L)].shape, A.shape))
